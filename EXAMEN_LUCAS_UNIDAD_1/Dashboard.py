...
def main(page: ft.Page):
    ...
    page.window.center()
    page.title = "Sistema - Online de Reservaciones de Campo La Bicolor"
    ...
    async def reservar_cupo_async():
        mensaje.value = "⏳ Reserva su Campo..."
        page.update()
        ...
        contador.value = f"campo  reservados: {cupos_reservados['cantidad']}"
        page.update()
    ...
    page.add(
        ft.Column(
            [
                ft.Text("🌈 RESERVACIONES DE CAMPO LA BICOLOR",
                        size=29, weight=ft.FontWeight.BOLD, color="#14EE10"),
                ft.Divider(height=20),
                ft.Text("Bienvenido al sistema de gestión de LA BICOLOR", size=18),
